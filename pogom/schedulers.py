...
class SpeedScan(HexSearch):
    ...
    def schedule(self):
        ...
        log.info('Temp1 %f seconds', (end - start))
        ...
        log.info('Temp2 %f seconds', (end - start))
        sp_by_id = {}
        for sps in cell_to_linked_spawn_points.itervalues():
            for sp in sps:
                sp_by_id[sp['id']] = sp
        log.info('Temp2.5 %f seconds', (end - start))
        ...
        log.info('Temp3 %f seconds', (end - start))
        ...
        log.info('Temp4 %f seconds', (end - start))
    ...
    def next_item(self, status):
        ...
        for i, item in enumerate(q):
            ...
            if score > best['score']:
                best = {'score': score, 'i': i , 'distance': distance}
                best.update(item)
